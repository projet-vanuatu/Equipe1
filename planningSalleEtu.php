...
<html> 
 ...
 <body>
    ...
    <img   src="logo.JPG" alt="Logo" style="width:52px;">
          ...
          <a href="consulterPlanningEtu.php">Planning personnel</a>
          <div class="subnav">
              <button class="subnavbtn">Consulter planning &nbsp;<i class="fa fa-caret-down"></i></button>
              <div class="subnav-content">
                  <a href="planningFormEtu.php">Par formation</a>
                  <a href="planningSalleEtu.php">Par salle</a>
  ...
  <div class="row" style="width:100%;">
      <div class="col-sm-1">
       ...
       <div class="col-sm-2">
            ...
            <div class=" well" style="height:15.5%;"></div>
           <div   class="jumbotron"class="well">

           <center><label  for="sel1">Paramètres d'affichage :</label></center>
             
               <form  action ='planningSalle.php'>
               <label   for="sel1">Salle :</label>
                <select size="20" class="form-control"  name="ids" >
               <?php             
                  for($i=0;$i<=count($salle)-1;$i++){
              ?>
                  <Option <?php if($idss == $salle[$i]['IdS'] ){echo "selected";}  ?>  value ="<?php echo $salle[$i]['IdS'] ?>"><?php echo $salle[$i]['NomS']." - ".$salle[$i]['NomSITE'] ?></option>     
              <?php
                  }
              ?>
                </select>        
